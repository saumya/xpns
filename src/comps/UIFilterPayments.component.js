...
class UIFilterPayments extends Component {
      ...
      <Fragment>
        {
            ...
            <Paper style={{marginTop:'4.5em',paddingTop:'1em',paddingBottom:'1em',width:'90%',marginLeft:'5%', backgroundColor:'#FFEBEE'}}>
              <Typography type="headline" component="h5">
                {''+this.state.filteredTotal+''}
              </Typography>
              <Typography component="p">
                {'For= '+this.state.filterByInfo}
              </Typography>
  ...
  handleCloseFilterUI = (filterObj) => {
    ...
    //
    var aSpendings = Object.values(this.props.allData.spendings)
...
export default UIFilterPayments